...
import { Search, Lock, Pin, PinOff } from 'lucide-react';
import './RoomList.css';
    ...
    <div className="middle-panel">
      ...
      <div className="search-container">
        <div className="sidebar-search-bar">
          <span className="sidebar-search-icon"><Search size={16} strokeWidth={2} /></span>
          <input 
            type="text" 
            placeholder="Search" 
            value={searchTerm}
          ...
          <ul className="item-list">
            ...
            {filteredRooms.map((room) => (
              ...
              >
                ...
                {room.isPrivate && <span className="lock-indicator"><Lock size={14} strokeWidth={2} /></span>}
              </li>
            ))}
          </ul>
              ...
              filteredUsers.map((user, idx) => {
                ...
                >
                  ...
                  <div className="item-info">
                    <span className="item-name">
                      {usernameStr}
                      {isPinned && <span className="pinned-icon-small"><Pin size={12} strokeWidth={2} /></span>}
                    </span>
